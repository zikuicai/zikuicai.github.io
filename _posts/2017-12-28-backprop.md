...
**Still foggy?**
![backprop](zikuicai.github.io/fig/backprob.png)

**Why are these 4 equations important?**

Because with these 4 equations, we can compute every thing we need to optimize.
...
Let's implement this algorithm with the following python code:
---
